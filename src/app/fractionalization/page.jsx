...
const allocationModel = [
  ...
  { title: 'Liquidity and reserves', percentage: '10%', note: 'Stabilization reserves, buyback/redemption design where appropriate, and contingency planning.' },
    ...
    <div className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden px-4 py-20 md:py-28">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <div>
            <div className="mb-5 text-sm font-semibold uppercase tracking-[0.35em] text-emerald-300">Fractionalization</div>
            <h1 className="text-5xl font-black leading-tight tracking-tight text-white text-glow md:text-7xl">
              Asset-backed participation, not speculative ICO marketing.
            </h1>
            <p className="mt-7 max-w-3xl text-xl leading-9 text-gray-300">
              PrimusNeo reframes token-era fundraising into compliant fractional ownership, contribution accounting, QUSDC-compatible distribution rails, and governed participation around real-world assets, software ecosystems, and regenerative community infrastructure.
            </p>
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <GradientButton href="/governance-platform">Governance platform</GradientButton>
              <GradientButton href="/contact" variant="secondary">Discuss a structure</GradientButton>
            </div>
          </div>
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-xl">
            ...
            <p className="text-lg leading-8 text-gray-200">
              Instead of selling generic tokens, each opportunity should describe the underlying asset, rights, governance, compliance requirements, distribution logic, digital twin data, and operating responsibilities.
            </p>
            <div className="mt-7">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            ...
            <div className="space-y-4">
              {fractionalTracks.map((tier, index) => {
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-7xl rounded-[2rem] border border-emerald-300/20 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.12),transparent_35%),rgba(255,255,255,0.045)] p-8 md:p-12">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <NumberedCard number="03" title="Twin">Use Plan Systems to connect spatial context, documents, media, telemetry, and field updates.</NumberedCard>
...
export default FractionalizationPage;

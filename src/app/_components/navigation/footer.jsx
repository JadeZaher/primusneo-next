        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="space-y-4 md:col-span-2">
            ...
            <p className="max-w-md text-gray-400">
              A governance platform for software solutions. Connecting NEOS,
              Plan Systems, OASIS, and Escherbridge into one delivery model for governed,
              spatial, interoperable ecosystems.
            </p>
          </div>
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/plan-systems" className="text-gray-400 transition hover:text-white">Plan Systems</a></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://plan-systems.org/" target="_blank" rel="noreferrer" className="text-gray-400 transition hover:text-white">Plan Systems</a></li>
